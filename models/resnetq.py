...
class BasicBlock(Module):
    ...
    def forward(self, input_):
        # Use functional since addition in quantized not supported
        return self.relu1(self.functional.add(self.mainline(input_), self.shortcut(input_)))


class ResNet18Q(Classifier):
    def __init__(self):
        convs = Sequential(
